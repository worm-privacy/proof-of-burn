...
component main = ProofOfBurn(
    4, // maxNumLayers (Maximum number of Merkle-Patricia-Trie proof nodes supported)
    ...
    5,  // maxHeaderBlocks (Average header len of the last 100 blocks as of July 2nd 2025 is 643 bytes ~ 4.72 blocks)
