...
// Proof-of-Work: Assert keccak(burnKey | revealAmount | burnExtraCommitment | 'EIP-7503') < 2 ^ (256 - 8 * minimumZeroBytes)
//
// Reviewers:
//   Keyvan: OK
//
template ProofOfWorkChecker() {
    ...
    var hasherInputLen = 32 + 32 + 32 + 8;
    signal hasherInput[hasherInputLen] <== ConcatFixed4(32, 32, 32, 8)(
        burnKeyBytes, revealAmountBytes, burnExtraCommitmentBytes, eip7503
    );
