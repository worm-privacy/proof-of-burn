...
burn_key = 20615728996108507012247633598804393039420317165659513483865090248589612027786

pob_expected_commitment = expected_commitment(
    [
        int.from_bytes(
            bytes.fromhex(
                "5308f44ce9d08d419874251d95bc9674080a516960ad3220f3a1201fab77e48f"
            ),
            "big",
        ),  # Block root
